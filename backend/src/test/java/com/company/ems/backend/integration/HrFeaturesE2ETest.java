...
class HrFeaturesE2ETest {
        ...
        @MockitoBean
        AttendanceAdjustmentService adjustmentService;
        @MockitoBean
        PerformanceReviewService reviewService;
        @MockitoBean
        KpiObjectiveService kpiService;
        @MockitoBean
        ...
        void globalSetup() {
                ...
                hrPrincipal = new CustomUserPrincipal(1L, "hr01", "pw", "HR Member", true, true, true, true,
                                List.of(), java.util.Set.of(com.company.ems.backend.user.enums.DataScope.ALL));
                empPrincipal = new CustomUserPrincipal(2L, "emp01", "pw", "Employee Member", true, true, true, true,
        ...
        class EmployeeManagementTests {
                ...
                void getEmployeeById_returns200() throws Exception {
                        EmployeeResponse emp = EmployeeResponse.builder().id(10L).firstName("Nguyen").lastName("Van A")
                                        .build();
                ...
                void createEmployee_returns201() throws Exception {
                        EmployeeResponse emp = EmployeeResponse.builder().id(11L).firstName("Tran").lastName("Thi B")
                                        .build();
                ...
                void updateEmployee_returns200() throws Exception {
                        EmployeeResponse emp = EmployeeResponse.builder().id(10L).firstName("Nguyen")
                                        .lastName("Van A Updated").build();
                ...
                void getMyProfile_returns200() throws Exception {
                        com.company.ems.backend.employee.dto.PublicEmployeeResponse profile = com.company.ems.backend.employee.dto.PublicEmployeeResponse
                                        .builder()
        ...
        class LeaveManagementTests {
                ...
                void getAllLeaves_returns200() throws Exception {
                        ...
                        Mockito.when(leaveService.getAllLeaves(anyInt(), anyInt(), isNull(), isNull(), isNull(),
                                        isNull(), isNull()))
                                        .thenReturn(page);
        ...
        class AttendanceTests {
                ...
                void listAttendance_returns200() throws Exception {
                        ...
                        Mockito.when(attendanceService.getAttendance(anyInt(), anyInt(), isNull(), isNull(), isNull(),
                                        isNull(), any()))
                                        .thenReturn(page);
                ...
                void getAttendanceSummary_returns200() throws Exception {
                        ...
                        Mockito.when(attendanceService.getSummary(isNull(), isNull(), isNull(), any()))
                                        .thenReturn(summary);
                ...
                void getAttendanceCalendar_returns200() throws Exception {
                        com.company.ems.backend.attendance.dto.AttendanceCalendarResponse calendar = new com.company.ems.backend.attendance.dto.AttendanceCalendarResponse();
                        Mockito.when(attendanceService.getMonthlyCalendar(isNull(), isNull(), any()))
                                        .thenReturn(calendar);
        ...
        class AttendanceAdjustmentTests {
                ...
                void getMyAdjustments_returns200() throws Exception {
                        PageResponse<AdjustmentRequestSummaryResponse> page = PageResponse.of(List.of(), 0, 20, 0L, 0,
                                        "adjustments");
                ...
                void getPendingAdjustments_returns200() throws Exception {
                        ...
                        PageResponse<AdjustmentRequestSummaryResponse> page = PageResponse.of(List.of(), 0, 20, 0L, 0,
                                        "adjustments");
                        Mockito.when(adjustmentService.getPendingForApprover(anyInt(), anyInt(), any()))
                                        .thenReturn(page);
        ...
        class PerformanceReviewTests {
                ...
                void listReviews_returns200() throws Exception {
                        PageResponse<PerformanceReviewDto.Response> page = PageResponse.of(List.of(), 0, 10, 0L, 0,
                                        "reviews");
                        Mockito.when(reviewService.listReviews(isNull(), isNull(), anyInt(), anyInt()))
                                        .thenReturn(page);
        ...
        class KpiObjectiveTests {
                ...
                void listKpis_returns200() throws Exception {
                        PageResponse<KpiObjectiveDto.Summary> page = PageResponse.of(List.of(), 0, 10, 0L, 0, "kpis");
                        Mockito.when(kpiService.listObjectives(anyInt(), anyInt(), isNull(), isNull(), isNull(),
                                        isNull(), isNull()))
                                        .thenReturn(page);

...
class AttendanceAdjustmentServiceImplTest {
    ...
    /* ── Mocks ──────────────────────────────────────────────────────────── */
    @Mock AttendanceAdjustmentRequestRepository requestRepository;
    @Mock AttendanceAdjustmentHistoryRepository historyRepository;
    @Mock AttendanceRepository                  attendanceRepository;
    @Mock EmployeeRepository                    employeeRepository;
    @Mock UserRepository                        userRepository;
    @Mock WorkflowEngineService                 workflowEngineService;
    ...
    class SubmitRequest {
        ...
        void success_savesPendingRequest() {
            ...
            ArgumentCaptor<AttendanceAdjustmentRequest> captor =
                    ArgumentCaptor.forClass(AttendanceAdjustmentRequest.class);

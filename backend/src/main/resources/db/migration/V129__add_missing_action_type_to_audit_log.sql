...
ALTER TABLE audit_log ADD COLUMN IF NOT EXISTS action_type VARCHAR(50) NOT NULL COMMENT 'LOGIN_SUCCESS | LOGIN_FAILED | TOKEN_REFRESH_SUCCESS | TOKEN_REFRESH_FAILED | LOGOUT | TOKEN_REVOKED' AFTER entity_id;

...
public class LeaveServiceImpl implements LeaveService {
    ...
    public LeaveResponse createLeaveRequest(LeaveRequest request) {
        ...
        if (request.getEndDate().isBefore(request.getStartDate())) {
            throw new BusinessException("INVALID_DATE_RANGE", messages.get(MessageCode.LEAVE_INVALID_DATE_RANGE));
        }
        if (request.getStartDate().isBefore(LocalDate.now())) {
            throw new BusinessException("INVALID_START_DATE", messages.get(MessageCode.LEAVE_INVALID_START_DATE));
        }
    ...
    public LeaveResponse approveLeave(Long id, ApproveLeaveRequest request) {
        ...
        if (leave.getStatus() != LeaveStatus.PENDING) {
            throw new BusinessException("LEAVE_NOT_PENDING", messages.get(MessageCode.LEAVE_NOT_PENDING, leave.getStatus()));
        }
        ...
        if ("APPROVED".equals(statusStr)) {
            ...
            throw new BusinessException("INVALID_STATUS", messages.get(MessageCode.LEAVE_INVALID_STATUS, request.getStatus()));
        }
    ...
    public void cancelLeave(Long id) {
        ...
        if (leave.getStatus() != LeaveStatus.PENDING) {
            throw new BusinessException("LEAVE_CANNOT_CANCEL", messages.get(MessageCode.LEAVE_CANNOT_CANCEL, leave.getStatus()));
        }

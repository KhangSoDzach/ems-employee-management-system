...
public class IncidentMapper {
    ...
    private static final DateTimeFormatter DETAIL_FMT =
    ...
    private static final Map<IncidentType, String> TYPE_LABEL = Map.of(
            IncidentType.HARDWARE_MALFUNCTION,  "Hardware Malfunction",
            IncidentType.SCREEN_FLICKERING,     "Screen Flickering",
            IncidentType.BATTERY_ISSUE,         "Battery Issue",
            IncidentType.PERIPHERAL_NOT_WORKING,"Peripheral Not Working",
            IncidentType.SOFTWARE_OS_ISSUE,     "Software / OS Issue",
    ...
    public IncidentDto.ReportDetail toDetail(AssetIncidentReport r) {
        return IncidentDto.ReportDetail.builder()
                ...
                .incidentTypeLabel(TYPE_LABEL.getOrDefault(r.getIncidentType(), r.getIncidentType().name()))
    ...
    public IncidentDto.AdminListItem toAdminItem(AssetIncidentReport r) {
        return IncidentDto.AdminListItem.builder()
                ...
                .issueTypeLabel(TYPE_LABEL.getOrDefault(r.getIncidentType(), r.getIncidentType().name()))

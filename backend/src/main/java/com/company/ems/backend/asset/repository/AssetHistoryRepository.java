...
public interface AssetHistoryRepository extends JpaRepository<AssetHistory, Long> {
    ...
    Page<AssetHistory> findByAssetId(
            @Param("assetId") Long assetId,
            Pageable pageable);
    @Override default void delete(AssetHistory e)   { throw new UnsupportedOperationException(); }
    @Override default void deleteById(Long id)       { throw new UnsupportedOperationException(); }
    @Override default void deleteAll()               { throw new UnsupportedOperationException(); }
}
                    ...
                    <div className="p-6 space-y-8">
                        ...
                        <section className="space-y-4">
                            ...
                            <div className="grid grid-cols-2 gap-y-4 gap-x-6 bg-muted/20 p-4 rounded-xl border border-border/50">
                                <div>
                                    <p className="text-xs font-medium text-muted-foreground mb-1">Nhân viên</p>
                                    <p className="text-sm font-semibold">{CURRENT_USER.name}</p>
                                </div>
                                <div>
                                    <p className="text-xs font-medium text-muted-foreground mb-1">Mã NV</p>
                        ...
                        <section className="space-y-4">
                            ...
                            <div className="rounded-xl border shadow-sm overflow-hidden">
                                <div className="grid grid-cols-2 divide-x border-b bg-muted/20">
                                    <div className="p-4">
                                        <p className="text-xs font-medium text-muted-foreground mb-1">Ngày bắt đầu</p>
                                        <p className="text-sm font-semibold">{format(request.startDate, DATE_FORMAT)}</p>
                                    </div>
                                    <div className="p-4">
                                        <p className="text-xs font-medium text-muted-foreground mb-1">Ngày kết thúc</p>

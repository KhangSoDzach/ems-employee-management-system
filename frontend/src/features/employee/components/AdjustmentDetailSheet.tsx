                ...
                <SheetHeader className="px-6 py-5 border-b">
                    ...
                    <div className="mt-3 flex items-center gap-2">
                        ...
                        <span className="text-xs text-muted-foreground">
                            {SHEET_LABELS.createdAt} {format(request.dateCreated, DATETIME_FORMAT)}
                        </span>
                    </div>
                </SheetHeader>
                        ...
                        <div className="space-y-3">
                            {hasIn && (
                                <div className="flex items-center justify-between p-3 rounded-xl border bg-muted/30">
                                    <div>
                                        <p className="text-xs text-muted-foreground mb-0.5">{SHEET_LABELS.oldCheckin}</p>
                            ...
                            {hasOut && (
                                <div className="flex items-center justify-between p-3 rounded-xl border bg-muted/30">
                                    <div>
                                        <p className="text-xs text-muted-foreground mb-0.5">{SHEET_LABELS.oldCheckout}</p>
                                        <p className="text-sm font-semibold text-muted-foreground">

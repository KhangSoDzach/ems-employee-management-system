...
const TEXT = {
    ...
    CARD_DESC: "Cung cấp thông tin chi tiết về sự cố để đội ngũ kỹ thuật hỗ trợ bạn tốt nhất.",
    ...
    TOAST_VALIDATION_ERROR: "Vui lòng kiểm tra lại các trường thông tin bị thiếu.",
...
export const AssetIncidentForm: React.FC<AssetIncidentFormProps> = ({
    ...
    const onSubmit = async (values: AssetIncidentValues) => {
        ...
        toast.promise(apiPromise, {
            ...
            error: (err: unknown) => {
                const message = err instanceof Error ? err.message : TEXT.TOAST_ERROR_GENERIC;
                return message;
            },
        });
    };
        ...
        <Card className="w-full max-w-2xl mx-auto shadow-lg border-muted-foreground/20">
            <CardHeader className="space-y-1">
                <div className="flex items-center gap-2 text-primary mb-1">
                    ...
                    <span className="text-xs font-bold uppercase tracking-wider">{TEXT.SYSTEM_NAME}</span>
                </div>
                <CardTitle className="text-2xl font-extrabold">{TEXT.CARD_TITLE}</CardTitle>
                <CardDescription>
                    {TEXT.CARD_DESC}
                </CardDescription>
            </CardHeader>
                            ...
                            <FormField
                                ...
                                render={({ field }) => (
                                    <FormItem>
                                        ...
                                        <FormControl>
                                            <Input placeholder={TEXT.PLACEHOLDER_ASSET_ID} {...field} />
                                        </FormControl>
                                ...
                                render={({ field }) => (
                                    <FormItem>
                                        ...
                                        <Select onValueChange={field.onChange} defaultValue={field.value}>
                                            <FormControl>
                                                <SelectTrigger>
                                                    <SelectValue placeholder={TEXT.PLACEHOLDER_INCIDENT_TYPE} />
                                                </SelectTrigger>
                                            </FormControl>
                                            <SelectContent>
                                ...
                                <FormItem>
                                    ...
                                    <Select onValueChange={field.onChange} defaultValue={field.value}>
                                        ...
                                        <SelectContent>
                                            ...
                                            <SelectItem value="critical">{TEXT.SEV_CRITICAL}</SelectItem>
                                        </SelectContent>
                                    </Select>
                                    <FormMessage className="text-xs font-medium" />
                                </FormItem>

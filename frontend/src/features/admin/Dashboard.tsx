...
const TEXT = {
  ...
  modalDesc: "Điền thông tin cơ bản để khởi tạo hồ sơ nhân sự trong hệ thống.",
  sectionBasic: "Thông tin cơ bản",
  labelEmpId: "Employee ID",
  descEmpId: "ID được tạo tự động bởi hệ thống.",
  ...
  return (
    <div className="bg-white dark:bg-gray-800 rounded-xl p-4 border border-gray-100 dark:border-gray-700 shadow-sm">
      <div className="flex justify-between items-start mb-3">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-xs text-primary font-medium">{TEXT.prefixCode}{code}</p>
          </div>
        </div>
        <span
      ...
      <div className="grid gap-2 border-t border-gray-50 dark:border-gray-700 pt-3 text-sm text-gray-600 dark:text-gray-400">
        <div>{TEXT.prefixId}{id}</div>
        <div className="truncate">{TEXT.prefixEmail}{email}</div>
        <div>{TEXT.prefixPhone}{phone}</div>
      </div>
    </div>
  )
}
            ...
            <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40 backdrop-blur-sm">
              ...
              <div className="w-full max-w-5xl bg-white dark:bg-gray-900 rounded-2xl shadow-2xl border border-gray-200 dark:border-gray-800">
                ...
                <div className="max-h-[75vh] overflow-y-auto">
                  ...
                  <div className="p-10">
                    <form className="grid grid-cols-1 md:grid-cols-2 gap-8" onSubmit={form.handleSubmit(onSubmit)}>

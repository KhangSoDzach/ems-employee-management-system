...
import { type AdjustmentRequest, DATETIME_FORMAT, DATE_FORMAT, AUDIT_ACTION_CONFIG, ADJUSTMENT_STATUS_CONFIG, DATETIME_LOG_FORMAT } from "../../employee/adjustment-request.constants"
            ...
            >
                ...
                {request ? (
                    <div className="flex-1 overflow-y-auto p-6 space-y-8">
                        <div className="flex flex-col gap-8 text-sm">
                            <ReviewSheetProfile
                                name={request.auditTrail[0]?.actor || SYSTEM_MESSAGES.STATUS.UNKNOWN}
                                id={request.id}
                                ...
                                <div className="flex flex-col gap-4">
                                    <div className="flex items-center justify-between bg-white p-6 rounded-xl border border-slate-200 shadow-sm relative overflow-hidden group">
                                        ...
                                        <div className="flex flex-col z-10">
                                            <span className="text-[10px] text-slate-400 uppercase font-bold tracking-widest mb-1.5">{SYSTEM_MESSAGES.REVIEW.ORIGINAL}</span>
                                        ...
                                        <div className="flex flex-col text-right z-10">
                                            <span className="text-[10px] text-blue-500 font-bold uppercase tracking-widest mb-1.5">{SYSTEM_MESSAGES.REVIEW.PROPOSED}</span>
                ...
                {request && (
                    <ReviewSheetFooter
                        ...
                        isPending={request.status === "PENDING" || request.status === "RETURNED"}

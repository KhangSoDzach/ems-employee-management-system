...
function getRedirectByRole(roles: string[]): string {
  if (roles.includes(AUTH_ROLES.ADMIN)) return "/assets";
  if (roles.includes(AUTH_ROLES.HR)) return "/hr-employees";
  if (roles.includes(AUTH_ROLES.MANAGER)) return "/members";
  return "/employee";
}

...
export const EDIT_REQUEST_TEXT = {
  ...
  DESCRIPTION:
    "Nhập thông tin để cập nhật yêu cầu điều chỉnh chấm công của bạn.",
...
export const CREATE_LEAVE_TEXT = {
  ...
  TOAST_VALIDATION_ERROR: FORM_VALIDATION_MESSAGES.MISSING_CONTENT,
  ASTERISK: "*",
  BALANCE_CURRENT: "Số dư phép năm hiện tại:",
  BALANCE_PENDING: "Số ngày đang chờ duyệt (khóa tạm):",
  BALANCE_AVAILABLE: "Số dư khả dụng để đăng ký:",
} as const;
export const ASSET_INCIDENT_TEXT = {
  CARD_TITLE: SYSTEM_MESSAGES.MY_ASSETS.REPORT_TITLE,
  CARD_DESC:
    "Cung cấp thông vị chi tiết về sự cố để đội ngũ kỹ thuật hỗ trợ bạn tốt nhất.",
...
export const ATTENDANCE_VALIDATION_MESSAGES = {
  SHIFT_1_START_REQUIRED: "Vui lòng nhập giờ vào ca 1.",
  SHIFT_1_END_REQUIRED: "Vui lòng nhập giờ tan ca 1.",
  SHIFT_1_END_INVALID: "Giờ tan ca 1 phải lớn hơn giờ vào ca 1.",
  SHIFT_2_START_REQUIRED: "Vui lòng nhập giờ vào ca 2.",
  SHIFT_2_END_REQUIRED: "Vui lòng nhập giờ tan ca 2.",
  SHIFT_2_END_INVALID: "Giờ tan ca 2 phải lớn hơn giờ vào ca 2.",
  SHIFT_2_OVERLAP: "Giờ vào ca 2 phải lớn hơn hoặc bằng giờ tan ca 1.",
  TOLERANCE_NUMBER: "Thời gian cho phép phải là số hợp lệ.",
  TOLERANCE_MIN: "Thời gian cho phép không được là số âm.",
  LATITUDE_TYPE: "Vĩ độ phải là số thập phân.",
  LONGITUDE_TYPE: "Kinh độ phải là số thập phân.",
  LATITUDE_INVALID: "Vĩ độ phải nằm trong khoảng [-90, 90].",
  LONGITUDE_INVALID: "Kinh độ phải nằm trong khoảng [-180, 180].",
  RADIUS_INVALID: "Bán kính phải là số dương lớn hơn 0.",

...
export const COMMON_TEXT = {
  ...
  ERROR_CONNECTING: "Lỗi kết nối máy chủ",
...
export const AUDIT_LOG_TEXT = {
  ...
  DESC: "Nhật ký kiểm toán tập trung, tuân thủ tiêu chuẩn an toàn thông tin ISO/IEC 27001.",
  SHOW_ANONYMOUS: "HIỆN BẢN GHI ẨN DANH",
  TAB_DATA: "Dữ liệu hoạt động",
  DETAIL_TITLE: "Chi Tiết Nhật Ký Kiểm Toán",
  SECTION_BASIC: "Thông tin cơ bản",
  SECTION_ACTOR: "Tác nhân hệ thống (Actor)",
  SECTION_TARGET: "Định danh nhân sự (Target)",
  SECTION_VALUES: "Chi tiết thay đổi dữ liệu",
  LABEL_TIME: "Thời gian",
  LABEL_RESOURCE: "Tài nguyên",
  LABEL_ACTION: "Hành động",
  LABEL_ACTOR: "Tác nhân",
  LABEL_IDENTIFIER: "Định danh",
  LABEL_IP: "Địa chỉ IP",
  LABEL_DETAIL_IP: "Địa chỉ mạng (IP)",
  LABEL_BROWSER: "Loại trình duyệt (Client)",
  LABEL_TARGET_NAME: "Định danh nhân sự (Name)",
  LABEL_TARGET_ID: "Mã (ID)",
  LABEL_TARGET_TYPE: "Phân loại (Type)",
  LABEL_OLD_VALUE: "Dữ liệu cũ (Old Value)",
  LABEL_NEW_VALUE: "Dữ liệu mới (New Value)",
  PLACEHOLDER_ACTOR: "Username...",
  PLACEHOLDER_IP: "192.168...",
  PLACEHOLDER_IDENTIFIER: "Họ tên người bị tác động...",

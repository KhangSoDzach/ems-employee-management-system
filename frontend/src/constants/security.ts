export const SECURITY_CONSTANTS = {
  ...
  TWO_FACTOR: {
    ...
    STATUS_OFF:
      "Hiện tại 2FA đang tắt. Chúng tôi khuyên bạn nên bật tính năng này.",
    STATUS_ON:
      "Xác thực hai yếu tố đang hoạt động. Tài khoản của bạn đã được bảo vệ tốt hơn.",
    DIALOG_ENABLE_TITLE: "Thiết lập xác thực 2 lớp",
    DIALOG_ENABLE_DESC:
      "Quét mã QR bằng ứng dụng xác thực (Google Authenticator, Authy...) để nhận mã OTP.",
    LABEL_SECRET_KEY: "Khóa bí mật (Secret Key)",
    COPY_SUCCESS: "Đã sao chép khóa bí mật!",
    WARNING_SECRET:
      "Khóa bí mật này chỉ hiển thị một lần duy nhất. Hãy lưu giữ cẩn thận.",
    ...
    MSG_INVALID_OTP: "Mã OTP không chính xác. Vui lòng thử lại.",
    ...
    RECOVERY_DESC:
      "Hãy lưu các mã này ở nơi an toàn. Bạn có thể dùng chúng để đăng nhập nếu mất quyền truy cập vào ứng dụng xác thực.",
    BTN_COPY_RECOVERY: "Sao chép mã",
    BTN_DOWNLOAD_RECOVERY: "Tải về (.txt)",

    ALERT_DISABLE_TITLE: "Bạn có chắc chắn muốn tắt 2FA?",
    ALERT_DISABLE_DESC:
      "Việc tắt 2FA sẽ làm giảm mức độ bảo mật cho tài khoản của bạn. Vui lòng xác nhận mật khẩu để tiếp tục.",
  ...
  SIDEBAR_SETTINGS: {
    ...
    PRIVACY_VIEW: {
      ...
      VISIBILITY_DESC:
        "Quyết định ai có thể xem thứ hạng và thống kê hiệu suất của bạn.",
      LOGGING: "Ghi nhật ký hoạt động",
      LOGGING_DESC:
        "Cho phép thu thập dữ liệu sử dụng để cải thiện trải nghiệm EMS.",
      DATA_MGMT: "Quản lý dữ liệu",
      DATA_MGMT_DESC:
        "Các hành động vĩnh viễn liên quan đến dữ liệu tài khoản.",
